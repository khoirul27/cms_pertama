                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <div class="text-center mb-5 pb-2">
                            ...
                            <a data-bs-toggle="collapse" data-bs-target=".multi-collapse" class="btn custom-btn smoothscroll mt-3">Start listening</a>
                        </div>
                        ...
                        <div class="col-lg-6 mx-auto text-lg-start">
                            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <?php $no = 1;
                                    foreach ($this->beranda_model->caraousel() as $a) { ?>
                                        <div class="carousel-item <?php if ($no == 1) {
                                            echo 'active';
                                        } ?>">
                                            <img src="<?= base_url('asset/admin/img/caraousel/' . $a['foto']) ?>"
                        ...
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    ...
                                    <a href="detail-page.html" class="custom-block-image-wrap">
                                        <img src="<?= base_url('asset/user/') ?>images/podcast/11683425_4790593.jpg"
                            ...
                            <div class="custom-block-info">
                                ...
                                <div class="profile-block d-flex">
                                    <img src="<?= base_url('asset/user/') ?>images/profile/woman-posing-black-dress-medium-shot.jpg"
                        ...
                        <div class="custom-block d-flex">
                            <div class="">
                                <div class="custom-block-icon-wrap">
                                    <div class="section-overlay"></div>
                                    <a href="detail-page.html" class="custom-block-image-wrap">
                                        <img src="<?= base_url('asset/user/') ?>images/podcast/12577967_02.jpg"
                                            class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="custom-block-info">
                                ...
                                <div class="profile-block d-flex">
                                    <img src="<?= base_url('asset/user/') ?>images/profile/handsome-asian-man-listening-music-through-headphones.jpg"
                                        class="profile-block-image img-fluid" alt="">
                        ...
                        <div class="section-title-wrap mb-5">
                            ...
                            <div class="dropdown mt-3">
                                ...
                                <ul class="dropdown-menu">
                                    <?php foreach ($this->beranda_model->ketegori() as $b) { ?>
                                        <li><a class="dropdown-item"
                                                href="<?= base_url('home/konten/' . $b['id_kategori']) ?>"><?= $b['kategori'] ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <?php foreach ($quer as $c) { ?>
                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="custom-block custom-block-overlay">
                                <a href="detail-page.html" class="custom-block-image-wrap">
                                    <img src="<?= base_url('asset/user/') ?>images/topics/physician-consulting-his-patient-clinic.jpg"
                                        class="custom-block-image img-fluid" alt="">
                                </a>
                                ...
                                <div class="custom-block-info custom-block-overlay-info">
                                    ...
                                    <a class="btn col-5 btn-square btn-outline-dark mx-1"
                                        href="<?= base_url('home/about/' . $c->slug) ?>">Detail</a>
                    ...
                    <div class="col-lg-4 col-12 mb-4 mb-lg-0">
                        <div class="custom-block custom-block-full">
                            <div class="custom-block-image-wrap">
                                <a href="detail-page.html">
                                    <img src="<?= base_url('asset/user/') ?>images/podcast/27376480_7326766.jpg"
                                        class="custom-block-image img-fluid" alt="">
                                </a>
                            </div>
